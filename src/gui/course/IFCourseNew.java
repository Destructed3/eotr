...
public class IFCourseNew extends root.IFTemplate {
    ...
    private void run() {
        this.tea = dsk.getData().lTea.get(0);
        this.rs = dsk.getData().lRoomStudy.get(0);
        this.duration = 2;
        setTable();
    ...
    public void fillCB_Tea(int topic) {
        ...
        dsk.getData().lTea.stream().forEach(ptea -> {
